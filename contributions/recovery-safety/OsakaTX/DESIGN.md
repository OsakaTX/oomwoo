...
All 253 tests pass headless (no ROS2, no Gazebo) — measured 2026-08-20:
...
> Count re-measured 2026-08-20 with `/home/hermes/.local/bin/pytest test/`
> (per-file: 31/33/32/25/22/11/32/10/23/13/21). 2026-08-16 run added 11 tests
