...
4. **RC override.** A human might manually drive the robot out of a stuck
   situation via teleop. The recovery controller should detect when a non-zero
   cmd_vel arrives from teleop and automatically reset to IDLE. This is
