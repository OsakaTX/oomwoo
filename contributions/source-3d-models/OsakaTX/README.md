...
| Dock auto-empty suction fan (Dock table) | `dock-auto-empty-fan/dock-auto-empty-fan.scad` | BOM row 77 (21.6–25.2V 65mm 350W ✓); identity unverified — no datasheet for BOM-named 13F704P640 / 64XC216-085D / MBD65 (re-checked 2026-09-11). Source-anchored presets added 2026-09-11 (see Claimed/Candidates row above): Nidec BL-V55-class + BG26, from primary vendor docs; Midea 64XC216-085D (Amazon B0CYHXV2LX) + Roborock dock modules (B0GCT2LYB5, goodsscene) remain the purchasable anchors (fetched 2026-08-19) | Candidate-parametric (see status column above); legacy preset retains the all-(estimate) class draft |
